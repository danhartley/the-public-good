    ...
    return (
        <Layout header="Website performance" title="Web performance" description={'Web performance'}>
            <section>
                ...
                <p>In addition to theoretical, or lab, tests, Google records <Links.EL link={{source:'https://developers.google.com/speed/docs/insights/v5/about'}}>real-world website performance</Links.EL>. These data are preferred when available though benchmarks remain useful for comparing versions of a site, and measuring the effect of changes on performance.</p>
                ...
                <p>Select Command+Option+C (Mac) or Control+Shift+C (Windows, Linux, Chrome OS). For more ways to open DevTools, see <Links.EL link={{source:'https://developer.chrome.com/docs/devtools/open/'}}>Google's help</Links.EL>.</p>

                <h3>Run Lighthouse</h3>

                <p>Look for Lighthouse in the top menu (it will likely be hidden at first but one or more of Element, Console, Network will be visible). For help on setting up and using Lighthouse, see <Links.EL link={{source:'https://developers.google.com/web/tools/lighthouse'}}>Google's page</Links.EL></p>
