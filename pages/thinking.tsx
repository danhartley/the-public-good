    ...
    return (
        <Layout title="Web Thinking" description={'Web Thinking'}>
            <section>
                ...
                <p>Before we begin let us secure the door against two hangers on to this discussion; he who wishes to shame others, and the moral exhibitionist, and hear no more from them.</p>
                ...
                <p>In the 1950s an ad hoc affiliation of American companies started a campaign called <Links.EL link={{source:'https://kab.org/'}}>Keep America Beautiful</Links.EL> with the intention of shifting blame for the waste caused by mass-produced plastics from the manufacturers to the public. It worked in two respects: the campaign was successful in diverting attention; but people also became aware of the impact of leaving rubbish; legislation followed, and the campaign is still active today.</p>

                <p>In 2002 BP rebranded itself as 'Beyond Petroleum', a declaration which was nothing more than a <Links.EL link={{source:'https://www.nytimes.com/2006/08/14/opinion/14kenney.html'}}>marketing slogan</Links.EL>. Following the Deepwater Horizon disaster in 2006, BP sold off its <Links.EL link={{source:'https://www.reuters.com/article/us-bp-solar/bp-turns-out-lights-at-solar-business-idUSTRE7BK1CC20111221?edition-redirect=uk'}}>solar assets</Links.EL> in 2011 and <Links.EL link={{source:'https://www.reuters.com/article/us-bp-wind-idUSBRE93208B20130403'}}>wind assets</Links.EL> in 2013.</p>
                ...
                <p>As part of their 'Beyond Petroleum' <Links.EL link={{source:'https://www.nytimes.com/2006/08/14/opinion/14kenney.html'}}>marketing campaign</Links.EL>, BP popularised the concept of the carbon footprint. In 2020, they released a <Links.EL link={{source:'https://www.knowyourcarbonfootprint.com/'}}>second carbon calculator</Links.EL> which, when it was introduced on Twitter, did not receive a favourable <Links.EL link={{source:'https://twitter.com/bp_plc/status/1186645440621531136'}}>reception</Links.EL>.</p>

                <p>Amy Westervelt's podcast series <Links.EL link={{source:'https://www.criticalfrequency.org/drilled'}}>Drilled</Links.EL></p>
                ...
                The <Links.EL link={{source:'https://www.bbc.com/future/article/20200618-climate-change-who-is-to-blame-and-why-does-it-matter'}}>debate</Links.EL> as to whether climate change is tackled most effectively through <Links.EL link={{source:'https://en.wikipedia.org/wiki/Individual_action_on_climate_change'}}>individual action</Links.EL>, or through collaborative initiatives, be they social or political, such as voting, protesting, and lobbying. 

                <p>In his article<Links.EL link={{source:'https://mashable.com/feature/carbon-footprint-pr-campaign-sham'}}> The carbon footprint sham</Links.EL>, Mark Kaufman argues the burden of responsibility for global warming must be placed squarely on the fossil fuel industry. He concludes,
                    <span class={styles.quote}>
                ...
                <p>In a Financial Times <Links.EL link={{source:'https://www.ft.com/content/b6bdc4b1-d41f-49f0-a3df-61614cc1a2b7'}}>review</Links.EL> <span class={styles.super}>paywall</span> of books by Michael E Mann, Bill Gates and Jonathan Franzen, the authors are presented respectively as favouring legislation, technology, and mitigation.</p>
                ...
                <p>Meat and dairy account for <Links.EL link={{source:'https://interactive.carbonbrief.org/what-is-the-climate-impact-of-eating-meat-and-dairy/">14.5%</a> of emissions. The total emissions for meat and dairy and food production as a whole continues to grow, as does the percentage growth for meat and dairy within the agriculture sector. This is mostly a good thing; more people have better access to the food they need, and have healthier <a href='}}>diets</Links.EL>. In a few, predominantly wealthy, countries meat and dairy consumption per capita has fallen, and the number of vegetarians has risen; but in the majority of countries, people are eating more meat and dairy, including India which has <Links.EL link={{source:'https://en.wikipedia-on-ipfs.org/wiki/Vegetarianism_by_country.html'}}>more vegetarians than the rest of the world combined</Links.EL>.</p>
                ...
                <p>The <Links.EL link={{source:'https://ourworldindata.org/renewable-energy'}}>impact</Links.EL> of renewable energies in lowering emissions has been greater, though not enough to prevent an overall increase (growth in demand <Links.EL link={{source:'https://www.iea.org/news/global-energy-demand-rose-by-23-in-2018-its-fastest-pace-in-the-last-decade'}}>exceeds</Links.EL> additions to supply from renewables). One quarter of global electricity production comes from renewables, and in 2019, around 11% of global primary energy. The profile of contributions is changing as more solar and wind power is added, but hydropower continues to dominate, accounting for more than all other forms combined.</p>
                ...
                <p>Energy is responsible for <Links.EL link={{source:'https://ourworldindata.org/ghg-emissions-by-sector">73.2%</a> of emissions. There is little individuals can do about these emissions, they are characteristic of the societies they live in, built into the roads, buildings, and transport they use. This background carbon footprint is insidious. In 2008 MIT <a href='}}>calculated</Links.EL> that a homeless person in the US had a carbon footprint of 8.5 tonnes. We may think this example unfair, but the figures add up; everyone in a rich country is living beyond the means of the plant before they have eaten one mouthful of food or taken one hot shower.</p>

                {/* what are the beneficial ways? */}
                {/* Individual action is important and something we should all champion. */}

                <p>We have seen that individual actions have a limited role in reducing emissions, that political, systemic change is essential, and that the two overlap, not always in beneficial ways. But what of the actions themselves, do they have <Links.EL link={{source:'https://en.wikipedia.org/wiki/Intrinsic_value_(ethics)'}}>intrinsic value</Links.EL>?</p>

                <p>This question is not easily answered, but the individual can take it on, at least in respect of themselves. I don't eat meat because it is unsustainable, but the reason I stopped was the contradiction between what I knew and what I did. This decision brought no hardship, and I continue to eat some dairy products. If everyone stopped eating meat and dairy that collective effort would <Links.EL link={{source:'https://ourworldindata.org/land-use-diets'}}>transform the planet</Links.EL>, but each single decision, though insignificant in global terms, has a greatest impact on the individual, and that should not be underestimated. </p>
                ...
                <p>An overhaul of how we do things is overdue. That we have to adapt and mitigate is no longer in doubt; governments, <Links.EL link={{source:'https://www.mckinsey.com/business-functions/sustainability/our-insights/climate-risk-and-decarbonization-what-every-mining-ceo-needs-to-know'}}>management consultancies</Links.EL>, and even <Links.EL link={{source:'https://www.bp.com/en/global/corporate/news-and-insights/reimagining-energy/sustainability-report-carbon-6-ways-bp-taking-action.html'}}>fossil fuel companies</Links.EL> acknowledge that climate change as a consequence of elevated greenhouse gas emissions, is destructive and requires a response.</p>

                // <p>But few of these institutions, governments, politicians, and businesses or their owners, are prepared to entertain radical change; from a mixture of caution, cynicism, opportunism, and innocent faith, they persevere with the practices that have given them prestige, money, and power. Bill Gates primarily favours technology to save the day, though he also <Links.EL link={{source:'https://www.gatesnotes.com/Energy/What-you-can-do-to-fight-climate-change'}}>promotes individual and political activity</Links.EL>; Mark Carney, the former head of the Bank of England, and a UN special envoy for climate and finance, <Links.EL link={{source:'https://www.un.org/en/climatechange/mark-carney-investing-net-zero-climate-solutions-creates-value-and-rewards'}}>still has faith in the markets</Links.EL>, though he stresses the importance of values as well as value; the British Government has a 10 point plan, but it is for a Green <span>Industrial</span> Revolution.</p>

                <p>They may be right. It may be that continuity is safer than disruption. But we are dealing with a new type of problem.</p>

                <p>The diversity and ingenuity of responses to climate change, and biodiversity loss is staggering, and <Links.EL link={{source:'https://www.poetryfoundation.org/poems/44688/to-his-coy-mistress'}}>had we but world enough and time</Links.EL>, we might concede, reluctantly because inequity and injustice are also in abundance that, as a species, we are conjuring up miracles.</p>
                
                <p>News jobs are promised, but the wages of low-skilled jobs are <Links.EL link={{source:'https://www.reuters.com/article/us-china-economy-retraining-idUSKCN0WM01B'}}>lower</Links.EL>, particularly in comparison to well-paid jobs in old industries which are often above average; this creates resistance to change from constituents, owners and their representatives in government. The loss in absolute terms is often greatest to executives and owners who have a strong incentive to invest in lobbying, but a relative higher loss is felt by the majority of employees. A general leveling-up of pay, reversing the trend in the <Links.EL link={{source:'https://www.epi.org/publication/ceo-compensation-2018/'}}>US</Links.EL> and Britain since the 1960s, would help; better wages improve lives, and recognising the intrinsic value of work rather than its tradable value, would be even more effective.</p>
                ...
                <p>One way to reduce the tension between individual and political action is to extend the traditional separation of powers in government beyond the executive, legislative and judicial to include citizens assemblies. Two examples are the assembly in <Links.EL link={{source:'https://en.wikipedia.org/wiki/Citizens%27_Assembly_(Ireland)'}}>Ireland</Links.EL> which considered a number of questions, and <Links.EL link={{source:'https://www.climateassembly.uk/'}}>Climate Assembly UK</Links.EL>.</p>
                ...
                <p>Informed discussion is now focused on how we should adapt rather than whether it is necessary, including questioning orthodox economic models and suppositions from within. In a report published 2 February 2021, <Links.EL link={{source:'https://www.gov.uk/government/publications/final-report-the-economics-of-biodiversity-the-dasgupta-review'}}>The Economics of Biodiversity</Links.EL>, undertaken on behalf of HM Treasury (UK), the author, Professor Partha Dasgupta, writes:
                    <span class={styles.quote}>
                ...
                <p>A more open debate; grand projets are popular with some politicians in particular, but they have a mixed record. The idea of <Links.EL link={{source:'https://www.greenthesinai.com/'}}>greening the Sinai desert</Links.EL> is stimulating, striking an optimistic note, but the mix of outside intervention - <Links.EL link={{source:'http://theweathermakers.nl/'}}>The Weather Makers</Links.EL>, the company behind the plan have not visited the area, nor can due to instability in the region - requiring huge investment, the temption of huge profits, and an authoritarian regime, and precious little local involvement, gives pause for thought.</p>
                ...
                <p>Failure to meet the Aichi Biodiversity Targets made in 2010 have been attributed in part to their form, which made them hard to measure. The first target was to ensure that <span class={styles.quote}>By 2020, at the latest, people are aware of the values of biodiversity and the steps they can take to conserve and use it sustainably.</span>A commendable goal, whose success or failure is hard to verify. The Aichi Targets are regarded as having <Links.EL link={{source:'https://www.nature.com/articles/d41586-020-00450-5'}}>failed</Links.EL>. The <Links.EL link={{source:'https://www.cbd.int/sp/targets/'}}>Aichi Targets</Links.EL> will be superseded by targets agreed in May 2021 at Kunming, China.</p>
                ...
                <p>Change at the scale required seems insurmountable, and it may prove to be beyond us; it is unlikely that tinkering with the system will suffice. There is scant evidence that our current models, institutions, and structures are adequate, or will submit to radical improvement. In our confrontation with climate change and biodiversity loss, even our triumphs are, at best, <Links.EL link={{source:'https://www.cfr.org/backgrounder/paris-global-climate-change-agreements'}}>moderate successes</Links.EL>, or at worst, <Links.EL link={{source:'https://www.cbd.int/gbo5'}}>failures</Links.EL>.</p>

                <p>How we act is up to each of us; we may chose to benefit from education, guidance, and help, but we possess the immediate and perpetual freedom to think; some enjoy the liberty of translating our thoughts into action, but <Links.EL link={{source:'https://www.frontiersin.org/articles/10.3389/fpubh.2019.00357/full'}}>many</Links.EL> have little or no agency, and others fear they will not in the future. As we have discovered over the past year, our autonomy is quickly lost.</p>

                This problem is exacerbated if we overestimate the value of our actions. For example, a household that buys only locally sourced meat may think it has done its bit, though this has <Links.EL link={{source:'https://ourworldindata.org/food-choice-vs-eating-local'}}>minimal impact</Links.EL> on greenhouse gas emissions.
                ...
                <p>Mann is worried that debates about personal choices will distract from the need to police carbon emissions. Diet is, however, more than simply a lifestyle choice; food production is big business. According to Our World in Data, <Links.EL link={{source:'https://ourworldindata.org/environmental-impacts-of-food'}}>food production</Links.EL> accounts for 26% of global greenhouse gas emissions.</p>
