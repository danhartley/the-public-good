  ...
  return (
    <>
      <Layout
        ...
        description={'It is impossible to defend ethical behaviour on economic grounds; nor is it necessary.'}
      ...
      >
        ...
        <section>
          ...
          <p>
            I stand by the pledges espoused by{' '}
            <Links.EL link={{ source: 'https://responsibletech.work/responsible-pledges/' }}>
