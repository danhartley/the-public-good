...
const Hyperlinks = () => {
  ...
  return (
    <Layout
      header="For the love of hyperlinks"
      rt="8 to 9"
      title="Web development | For the love of hyperlinks"
      description={
        'Hyperlink good practices explained. How to create accessible links with respect to size, colour, un/visited, internal/external states.'
      }
    ...
    >
      <section>
        ...
        <p>
          The far off lands are news stories, videos, applications, images, maps, and a multiplicity of other data each
          with its own, unique uniform resource locator -{' '}
          <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/URL' }}>URL</Links.EL> - colloquially known as a web
          address.
        </p>

        <p>
          The hyperlink, or link, needs only our command to initiate a series of requests and responses which fly around
          the world before depositing us at our destination.
        </p>
        ...
        <p>
          Authors use links to connect to resources that support their claims and - because they are courteous - to
          point out pages that are relevant or interesting to their reader. Their altruism is rewarded by improved{' '}
          <Links.EL link={{ source: 'https://blog.alexa.com/outbound-links-content-marketing/' }}>
        ...
        <p>
          If you want to link to a site - perhaps it is the only source available - but prefer to keep your association
          at arm's link, it is possible to make your feelings clear to search engines.
        </p>
        ...
        <p>
          If you don't want to upset your reader, make clear that a link leads to content that is sponsored, biased, or
          damaging.
        </p>
        ...
        <p>
          The reason to distinguish between visited and unvisited links is to save us from linking to pages we have
        ...
        <p>
          Developers have a responsibility to seek guidance as to which colours are legible. WebAIM is an advocate on
          behalf of those with disabilities but their advice is pertinent to everyone. For this site, I have followed
          their recommendations on{' '}
          <Links.EL link={{ source: 'https://webaim.org/blog/wcag-2-0-and-link-colors/' }}>
            appropriate colours for links
          </Links.EL>
          . Since the default colours for un/visited sites are blue and dark blue/purple I have selected hues of these
          two that work in both light and dark mode.
        </p>

        <p>
          You can check my selections for{' '}
        ...
        <p>
          The British Dyslexia Society's friendly style guide points out that{' '}
          <Links.EL
            link={{
              source:
        ...
        <p>
          ...
          the bottom of any descenders (as on this site).
        </p>

        <p>
          If you are able to activate mouse over or keyboard focus you will observe changes to links on this site that
          are part default, part convention.
        </p>

        <p>
          These signals confirm that the text is a link, and that it can be activated by clicking, tapping or hitting
          Enter.
        </p>
        ...
        <p>
          In order to minimise distraction some sites gather links in one place. In a short article this may be at the
          end of the piece. Some BBC articles group and list links as they go along, a technique which keeps the links
          close to the text they support.
        </p>

        <h3>Links to content on the same site</h3>

        <p>
          Links are agnostic as to where they live, they simply connect documents, often pages, no matter where they
          are.
        </p>

        <p>
          The Guardian, a large site with many internal references across different sections of the paper, makes no
          distinction between external and internal links, or between visited and unvisited links.
        </p>

        <p>
          The BBC also treats internal and external links alike but it signals the source of external links in the text
          of the link, for example, 'according to the Red Cross, citing government data.' Visited links are gray rather
          than black but neither the difference nor reason for the difference is evident.
        </p>

        <p>
          Some sites differentiate between internal and external links by{' '}
          <Links.EL link={{ source: 'https://developer.mozilla.org/en-US/docs/Learn/CSS/Styling_text/Styling_links' }}>
            including an icon on the link
          </Links.EL>{' '}
          but not everyone recognises or understands these icons which can also be confused with indicators that the
        ...
        <p>
          ...
          logged in. But opening in a new window or tab should always be signalled, e.g. (this link opens in new tab).
        </p>
        ...
        <p>
          One objection to opening external links in the same tab is that clicking the back button causes the page to
          reload. Since this behaviour is more sustainable (the energy required to resend the page is saved), you may
          choose to favour this approach over one that promotes accessibility. This website employs{' '}
          <Links.EL link={{ source: 'https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API' }}>
            service workers
          </Links.EL>{' '}
          so that, for the majority of users, the page loads from a local cache when they go back.
        </p>

        <p>
          If you would like to read a variety of opinions on the rights and wrongs of opening links in new tabs (or
          windows), I recommend{' '}
          <Links.EL link={{ source: 'https://uxmovement.com/navigation/why-external-links-should-open-in-new-tabs/' }}>
        ...
        <p>
          The relationship between the web address that appears in the address bar and hyperlinks is fundamental. The
          source of the hyperlink is the web address.
        </p>

        <p>
          According to a{' '}
          <Links.EL link={{ source: 'https://try.alexa.com/resources/website-traffic-sources' }}>
            report on what drives web traffic
          </Links.EL>{' '}
          from the data analytics company Alexa, between 30% and 50% of website visits come about by users entering the
          address they want in the address bar. The figure is at the higher end for business websites, and sectors where
          trust is important such as personal finance.
        </p>
        ...
        <p>
          They provide insight on the structure of the web site and where{' '}
          <Links.EL link={{ source: 'https://developer.mozilla.org/en-US/docs/Glossary/Breadcrumb' }}>
            breadcrumbs
          </Links.EL>{' '}
          are used there should be consistency between the two.
        </p>

        <h3>Fitts's law</h3>

        <p>
          Hyperlinks should be recognisable for all readers and on all devices. They should also be easy to click or
          tap.
        </p>

        <p>
          <Links.EL link={{ source: 'https://lawsofux.com/fittss-law/' }}>Fitts's law</Links.EL> is a function of the
          ratio between the distance to a target and the width of that target. In other words, clicking on or tapping a
          link should not require dexterity. As well as being large enough, this requires links to be sufficiently
          spaced.
        </p>
        ...
        <p>
          The BBC and The Guardian use different colours across their sites, including blue, black and red. But their
          links are always underlined, and the line is always below the bottom of descenders.
        </p>

        <p>
          The conventions around links have shifted. But underlined text that doesn't interfere with the text is a
          prerequisite.
        </p>

        <p>
          Differentiating between visited links and unvisited links depends on how useful this information is to the
          reader.
        </p>

        <p>
          Some sites use an icon to indicate that the source of a link is external. The website{' '}
          <Links.EL link={{ source: 'https://www.gov.uk/' }}>GOV.UK</Links.EL> removed them because they found that{' '}
          <Links.EL
            link={{ source: 'https://designnotes.blog.gov.uk/2016/11/28/removing-the-external-link-icon-from-gov-uk/' }}
          >
        ...
        <p>
          Hyperlinks lead us from one document to another irrespective of the site to which they belong. They link
          ideas, opinions, people, and stories in order to explain, contradict and clarify. The links themselves should
          be clear, accessible and consistent, not only within a site but across sites.
        </p>
