  ...
  return (
    <Layout header="Other" title="Other" description={'Other'}>
      <section>
        ...
        <p>
          The Internet is a democratic institution; we will do everything we can do to make our site accessible to all.
        </p>
        ...
        <p>
          Agree to a budget for performance, measure progress using lab tests and live data, and maintain our commitment
          to it throughout the life of the site.
        </p>
        ...
        <p>
          <div>
            Websites come under the heading ICT (Informationand Communication Technology). This category, which covers
            data centres, networks, and devices, accounts for approximately{' '}
            <Links.EL
              link={{
                source:
            ...
            of total global electricity use.
          </div>
        </p>
          ...
          <div className={styles.quote}>
            ...
            <div>
              ...
              <Links.EL
                link={{
                  source:
                    'https://www.zora.uzh.ch/id/eprint/110005/1/2014_Coroama_Schien_Preist_Hilty_Energy_Intensity_Internet_Home_Access.pdf',
                  label: 'PDF The energy intensity of the internet',
                }}
              >
                PDF
              </Links.EL>
