  ...
  return (
    <Layout header="Artefacts" title="Artefacts" description={'Artefacts'}>
      <section>
        ...
        <p>Artefacts can be useful as an asynchronous reference (their shelf life should be short) and sometimes nothing beats a quick illustration or the beautiful design that makes sense of a heap of disparate elements.</p>
