...
const Domains = () => {
  ...
  return (
    <Layout header="Domains" title="Domains" description={'Domains'}>
      <section>
        <p>
          For companies that build products or services, it's crazy to restrict the developers to coding. They should be
          domain experts.
        </p>
        <ul>
        ...
        <p>
          Developers work on your site every day. They are intimate with parts of it. They should be familiar with all
          of it. Don't waste their insight and their feedback.
        </p>
      </section>
      <Links.RelatedLinks
        links={[
