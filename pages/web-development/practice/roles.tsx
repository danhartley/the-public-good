  ...
  return (
    <Layout header="roles" title="" description={'roles'}>
      <section>
        ...
        <p>My role also meant I had no input into developing new products other than reviewing late stage figma designs. In other words, I was employed to implement a brief much in the way I had working whilst at a design agency.</p>
