    ...
    >
      <section>
        <div class={styles.day}>
          ...
          <Links.EL link={{source:'https://news.mongabay.com/2022/04/cradle-of-transformation-the-mediterranean-and-climate-change/', label:'Cradle of transformation: The Mediterranean and climate change'}}>Cradle of transformation: The Mediterranean and climate change</Links.EL>
          ...
          <ul>
            <li>In the parts of the Mediterranean that rely on rain-fed crops, the more concentrated and intense winter rainfalls anticipated by climate forecasts are likely to leech soils of key nutrients.</li>
            <li>Soil biodiversity, which includes everything from invisible microbes to insects and earthworms, is waning in the Mediterranean and could be pushing a critical food-producing region toward utter collapse.</li>
            <li>The loss of soil moisture could lead to a self-perpetuating cycle of drought. With less water evaporation as temperatures continue to bake the soil, there’s less rain to replenish that moisture, leading in turn to more drought.</li>
            <li>One way to adapt would be the introduction of drought-adapted crop varieties. That transition has already begun in parts of France’s wine industry.</li>
            <li>Irrigation may provide stopgap relief by bringing enough water to coax a few more harvests from drier soil. But the longer-term impacts could lead to a broader drawdown of the region’s water resources, and to a buildup of salt in soils — an effect that wrecked ancient Mesopotamian civilizations.</li>
          </ul>

          <Links.EL link={{source:'https://www.medecc.org/', label:'1st Mediterranean Assessment Report'}}>1st Mediterranean Assessment Report</Links.EL>
          <div>The Mediterranean Experts on Climate and environmental Change (MedECC)</div>

          <Links.EL link={{source:'https://www.youtube.com/watch?v=fgBozLCGUHY', label:'Cradle of transformation: The Mediterranean and climate change'}}>Cradle of transformation: The Mediterranean and climate change</Links.EL>
        ...
        <div class={styles.day}>
          ...
          <p>The Mediterranean has a subtropical climate with hot summers and mild winters. Precipitation is concentrated in the winter.</p>
          <p>The subtropics fall outside of the tropics of Cancer (in the northern hemisphere) and Capricorn (southern hemisphere).</p>
          <p>The tropics mark the most northerly and southerly (subsolar) points.</p>
          <p>The Tropic of Cancer (or the Northern Tropic) is the circle of latitude that contains the subsolar point at the June (or northern) solstice when the Northern Hemisphere is tilted toward the Sun to its maximum extent.</p>
          <p>The Tropic of Capricorn (or the Southern Tropic) is the circle of latitude that contains the subsolar point at the December (or southern) solstice when the Southern Hemisphere is tilted toward the Sun to its maximum extent.</p>
        ...
        <div class={styles.day}>
          ...
          <Links.EL link={{source:'https://esd.copernicus.org/articles/9/1191/2018/', label:'The climate of a retrograde rotating Earth'}}>The climate of a retrograde rotating Earth</Links.EL>
          ...
          <Links.EL link={{source:'https://link.springer.com/article/10.1007/s10745-006-9030-4?', label:'The ‘Design’ of Mediterranean Landscapes: A Millennial Story of Humans and Ecological Systems during the Historic Period'}}>The ‘Design’ of Mediterranean Landscapes: A Millennial Story of Humans and Ecological Systems during the Historic Period</Links.EL>
          <div>Jacques Blondel | Abstract</div>

          Factors to take into account:
          <ul>
            <li>One cannot understand the components and dynamics of current biodiversity in the Mediterranean without taking into account the history of human-induced changes.</li>
            <li>The various systems of land use and resource management that provided a framework for the blossoming of Mediterranean civilizations also had profound consequences on the distribution and dynamics of species, communities, and landscapes.</li>
            <li>The processes of domestication of plant and animal species, which first occurred in the eastern Mediterranean area some 10,000 years ago, contributed to the increase of certain components of biodiversity at several spatial scales. Positive and negative feedback cycles between cultural practices and natural systems at the local and regional levels have kept ecosystems robust and resilient.</li>
            <li>Assuming that human action can, to a certain extent, be considered a large-scale surrogate for natural sources of ecosystem disturbance, such patterns give support to the diversity-disturbance hypothesis—specifically, intermediate levels of disturbance have promoted biological diversity.</li>
            <li>Intraspecific adaptive variation increased as a result of human-induced habitat changes over millennia, resulting in bursts of differentiation during the later Holocene of local ecotypes and gene pools of domesticated and wild plant and animal species, with region-specific characters fitting them to local climate and environmental conditions.</li>
          </ul>

          <p>It is concluded that a high degree of resilience of Mediterranean ecosystems resulted in a dynamic coexistence of human and natural living systems, which in some cases provided stability, while fostering diversity and productivity.</p>

          <h3>Olive oil</h3>

          <h4>Papers</h4>

          <Links.EL link={{source:'https://www.mdpi.com/2076-2615/12/12/1551', label:'Impact of Super-High Density Olive Orchard Management System on Soil Free-Living and Plant-Parasitic Nematodes in Central and South Italy'}}>Impact of Super-High Density Olive Orchard Management System on Soil Free-Living and Plant-Parasitic Nematodes in Central and South Italy</Links.EL>
          <div>Silvia Landi et al. | Italy</div>

          <blockquote>
            <div>The SHD olive orchard system may change the soil nematode community associated with olive orchards, especially concerning plant-parasitic nematodes.</div>
            <div>The negative effects were mainly evident in stressed environments due to the dry summers and the lowest TOC content. Nevertheless, using a conservative and sustainable soil management method may maintain or improve the soil nematode community functionality and prevent the plant-parasitic nematode increase.</div>
          </blockquote>

          <Links.EL link={{source:'https://www.sciencedirect.com/science/article/abs/pii/S0308521X19310650', label:'Is new olive farming sustainable'}}>Is new olive farming sustainable?</Links.EL>
          ...
          <blockquote>
            ...
            <div>
              ...
              <ul>
                <li>Low density <strong>LD</strong> (100 trees ha<span class={styles.super}>-1</span>)</li>
                <li>Medium density <strong>MD</strong> (200 trees ha<span class={styles.super}>-1</span>)</li>
                <li>High density <strong>HD</strong> (400 trees ha<span class={styles.super}>-1</span>)</li>
                <li>Super high density <strong>SHD</strong> (1650 trees ha<span class={styles.super}>-1</span>)</li>
              </ul>
              ...
              <div>Agricultural management of olive trees has the potential to <strong>increase the accumulation of soil organic matter</strong>.</div>
              <div>The potential of olive tree plantations to <strong>store stable organic carbon acting as CO2 sinks</strong> has been confirmed under some soil conservation practices.</div>
              <div>Olive trees are drought-tolerant but water affects vegetative growth.</div>
              <div>Olive trees are also limited by frost and high temperatures, and to a lesser extent by low soil fertility.</div>
              <div>Trees in SHD orchards are usually irrigated, fertilized and trained to be suitable for mechanical harvesting and pruning, thus increasing productivity and profitability.</div>
          ...
          <Links.EL link={{source:'https://www.sciencedirect.com/topics/agricultural-and-biological-sciences/deficit-irrigation', label:'Deficit Irrigation'}}>Science Direct papers on Deficit Irrigation</Links.EL>

          <h4>Water</h4>

          <Links.EL link={{source:'https://www.mdpi.com/2073-4441/15/13/2486', label:'Sustainability of High-Density Olive Orchards: Hints for Irrigation Management and Agroecological Approaches'}}>Sustainability of High-Density Olive Orchards: Hints for Irrigation Management and Agroecological Approaches</Links.EL>
          <div>Justino Sobreiro et al. | Beja</div>

          <blockquote>
            <div>Traditionally, olive trees have been grown in the region surrounding the Mediterranean, mainly as a rainfed crop with low productivity given the typical dry environment of this region.</div>
            <div>In recent years, the expansion of olive oil and table olive production has been achieved through both an increase in the planted area and through intensification within and beyond the Mediterranean countries by increasing the orchards’ density and via the introduction of irrigation.</div>
            <div>In the last two decades, HD and SHD orchards, known as hedgerow olive orchards, have been developed to further reduce harvesting costs using over-the-row harvesting machines.</div>
          ...
          <ul>
            <li>The most common olive orchards in the Mediterranean area are those with MD (e.g. in lime soils of the southern parts of Portugal or Spain).</li>
            <li>They are rainfed or little irrigated, and the soil is kept weed-free by tillage or by partial (in the rows) or total herbicide application.</li>
            <li>Many have spontaneous cover plants, mainly in the interrows, which are used to some extent as grazing lands. In this case, animal manure provides some nutrient recycling for the ecosystem and complements the annual fertilization.</li>
            <li>The pruning is carried out in alternate years and is less intense than in the traditional orchards. The pruning residue is often burned.</li>
            <li>The sun exposure of the soil is lower due to the improved tree shade, resulting in better development of resident herbaceous vegetation that increases insect populations, improving biodiversity, and provides more protection against soil erosion than in the TD systems.</li>
            <li>The harvest is carried out by tree shaking using floor nets or wraps around the trees as collecting systems.</li>
            <li>These orchards have been upgraded over time by increasing plant density and providing better irrigation. This agricultural system is undergoing a fast transition to a higher-density system.</li>
            <li>Net production of these olive ecosystems is 3-6t ha<span class={styles.super}>-1</span> of fruits</li>
          </ul>
          ...
          <Links.EL link={{source:'https://livitaplus.com/varieta/?lang=en', label:'The best for the super high density olive farming'}}>The best for the super high density olive farming</Links.EL>
          <div>Livita +</div>

          <Links.EL link={{source:'https://www.agromillora.com/olint/en/high-density-or-sustainability/', label:'High density or sustainability?'}}>High density or sustainability?</Links.EL>
