    ...
    >
      <section>
        <div className={styles.day}>
          <span className={styles.date}>Wednesday 01 November 2023</span>
        ...
        <div className={styles.day}>
          <span className={styles.date}>Thursday 02 November 2023</span>
          <h3>Pinheiros</h3>
        ...
        <div className={styles.day}>
          <span className={styles.date}>Friday 03 November 2023</span>
