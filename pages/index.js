  ...
  return (
    <Layout title="Responsible web development" header="Responsible web development" description="Well-researched articles on responsible web development and the climate crisis.">
        ...
        <section>
            ...
            <p>Latest post, <Links.IL link={{ source:'web-development/sustainable-reporting-emissions'}}>Sustainable reporting of emissions</Links.IL>.</p>            
        </section>
        ...
        <section>
            ...
            <p>Data can be expensive, <Links.EL link={{label:'cable.co.uk: The cost of 1GB of mobile data in 237 countries', source:'https://www.cable.co.uk/mobiles/worldwide-data-pricing/'}}>especially in countries where only mobile connectivity is available</Links.EL>.</p>
            ...
            <h3>Accessibility</h3>
            <p>Using websites can be challenging <Links.EL link={{source:'https://web.dev/articles/accessibility'}}>for many reasons</Links.EL>.</p>
            <p><Links.EL link={{source:'https://web.dev/articles/load-faster-like-proxx'}}>Not all phones are smart</Links.EL>.</p>
