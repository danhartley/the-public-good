...
const Works = () => {
  return (
    <Layout header="Works" title="Works" description={'Works'}>
      <section>
        <p>
          There were twenty men working on the building now: common labourers, carpenters, electricians, plumbers, men
          fitting the parquet floors and men feeding fibre optic cabling through conduits. There was a team dedicated to
          the swimming pool in the basement. The sounds of drills and hammers poured onto the street.
        </p>
        <p>
          A palisade had been erected up to the level of the second floor. In front of the building was a tunnel to
          protect passersby as they walked on wooden duckboards. Behind the grey safety netting two men were spraying
          the walls red.
        </p>
        <p>
          The man stood on the scaffolding, his head dipped against the sun. He followed the progress of a woman as she
          walked up the street. He looked over at me – with that sense we possess of being watched – then looked back at
          the woman. The drilling from within stopped and somebody started shouting. The man turned his head to listen
          but kept his eyes on the woman. When she passed out of sight he turned, and was lost from sight.
        </p>
        <p>
          <div>The foreman was wearing a white hard hat and a yellow visibility jacket.</div>
        ...
        <p>
          <div>
            A generator somewhere inside the building cut out. We could hear men talking and moving. Metal banging on
            hard surfaces. The foreman looked up at the building as if interpreting what this change might mean. Someone
            shouted out an order. The high pitched rattle of the generator started up again.
          </div>
        </p>
        <p>
          <div>“Do you want a coffee?”</div>
          <div>
            The foreman looked across the street. Two men were standing under a red awning smoking. Two beers stood on a
            table beside them. I didn't know if they worked for me or not.
          </div>
          <div>“Let's go up the road a bit.” </div>
          <div>We stood under the shade of a catalpa. Leaves as large and soft as a woman's face. </div>
          <div>“Will there be an inspection?”</div>
          <div>“For sure. We'll be alright though.” </div>
          <div>
        ...
        <p>
          <div>
            The foreman explained what had been done and what was left to do. I nodded. But his words fell like rain.
            The grand plan of which I had believed I was the architect had not ended. It had never existed.
          </div>
        </p>
        <p>
          <div>
            I walked up the hill, the smooth wet calçada melting like burnt butter beneath my feet. Alfredo did not go
            back to the village where we spent the summer as boys but he often returned there in his paintings. The sea
            he painted was yellow, and the sand as black as night.
          </div>
        </p>
        <p>
          <div>
        ...
        <p>
          <div>The men will be paid, the building finished. They will move on to new sites.</div>
        </p>
      </section>
