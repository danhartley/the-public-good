  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>As a chat grows (the entire chat history is parsed each time a request is submitted) how does this affect computational effort?</li>
      ...
      <p>
        Or in the case of GPT-3 14.8 days using 10,000 GPUs.
      </p>

      <p>
        Neither the cost of training GPT-4 and fine tuning Chat for GPT-4 have not been made public.
      </p>
      ...
      <cite>
        <Links.EL link={{source:'https://arxiv.org/pdf/2303.08774.pdf', label:'GPT-4 Technical Report PDF'}}> GPT-4 Technical Report (PDF)</Links.EL>
      </cite>

      <h4>The context window</h4>

      The context window is the number of tokens - roughly equatable to words - that a model can process. In ChatGPT this is number of tokens or words that is accepted; anything more is discarded.

      <p>I've added Claude 2 from <Links.EL link={{source:'https://www.anthropic.com/', label:'Anthropic'}}>Anthropic</Links.EL> for comparison.</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td>GPT-3</td><td>4,000</td><td>3,000</td></tr>
          <tr><td>GPT-4</td><td>30,000</td><td>25,000</td></tr>
          <tr><td>Claude 2</td><td>100,000</td><td>75,000</td></tr>
        </tbody>
      </table>
