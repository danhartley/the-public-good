...
const NCSPartOne = () => {
  return (
    <Layout
      header="Natural climate solutions - trees"
      rt="10-15"
      title="Natural climate solutions - trees"
      description={'Is planting trees a good way to remove carbon dioxide from the atmosphere?'}
    ...
    >
      <section>
        ...
        <blockquote cite="https://www.nationalgeographic.com/environment/article/planting-trees-helps-fight-climate-change-but-we-need-billions-more-seedlings">
          Planting trees has quickly emerged as a seemingly simple way to soak up carbon emissions. Everybody likes it:
          Environmentalists, politicians, and corporations alike are pushing for a rapid expansion of reforestation
        ...
        <cite>
          <Links.EL
            link={{
              source:
                'https://www.nationalgeographic.com/environment/article/planting-trees-helps-fight-climate-change-but-we-need-billions-more-seedlings',
            }}
          >
        ...
        <p>
          ...
          <Links.EL link={{ source: 'https://ourworldindata.org/greenhouse-gas-emissions' }}>
            37 billion tonnes of carbon dioxide
          </Links.EL>{' '}
          each year. The most rational way to reduce or eliminate these emissions is to stop burning fossil fuels and
          use land appropriately.
        </p>
        <p>
          To offset emissions from those sectors that are hard to decarbonise it will be necessary to actively remove
          carbon dioxide from the atmosphere using{' '}
          <Links.EL link={{ source: 'https://www.ipcc.ch/sr15/faq/faq-chapter-4/' }}>negative emissions</Links.EL>{' '}
          solutions.
        </p>
        <p>
          There are broadly two forms of negative emissions, those that rely on technological innovation such as
          artificial direct air capture -{' '}
          <Links.EL link={{ source: 'https://www.iea.org/reports/direct-air-capture' }}> DAC</Links.EL> - and natural
          climate solutions - NCS. Bioenergy with carbon capture & storage - BECCS - is a combination of the two.
        </p>
        <p>
          Negative emissions technologies satisfy our desire to change, to invent, and to make money at the expense of
          low-tech, local solutions already in place. None have proved themselves at scale, and some are still in
          development.
        </p>
        <blockquote cite="https://www.carbonbrief.org/in-depth-experts-assess-the-feasibility-of-negative-emissions">
          There are currently no technologies to remove CO2 from the atmosphere that can be employed at scale. It is
          very doubtful any will be available at scale within the timescale required. Furthermore, many of the proposed
          technologies are likely to have a dire social and environmental impact on food security, community land rights
          and biodiversity.
        </blockquote>
        <cite>
          <Links.EL
          ...
          >
            {' '}
            Experts assess the feasibility of ‘negative emissions’ | Hannah Mowat
          </Links.EL>{' '}
        </cite>
        <p>
          Technological alternatives tend to solve problems piecemeal, hence the long-winded prose of bioenergy carbon
          capture and storage, a set of solutions in its infancy.
        </p>
        <blockquote cite="https://www.nature.org/en-us/what-we-do/our-insights/perspectives/natural-climate-solutions/">
          <strong>Natural climate solutions</strong> are conservation, restoration and improved land management actions
          that increase carbon storage or avoid greenhouse gas emissions in landscapes and wetlands across the globe.
        </blockquote>
        <cite>
          <Links.EL
            link={{
        ...
        <p>
          Natural climate solutions are conservative, resilient, and effective. Forest ecosystems account for around{' '}
          <Links.EL
            link={{
              source:
                'https://spiral.imperial.ac.uk:8443/bitstream/10044/1/80271/6/What%20role%20can%20forests%20play%20in%20tackling%20climate%20change.pdf',
          ...
          of all the carbon stored on land and absorb an estimated{' '}
          <Links.EL
        ...
        <p>
          The paper{' '}
          <Links.EL link={{ source: 'https://www.pnas.org/content/114/44/11645' }}>Natural climate solutions</Links.EL>{' '}
          by Griscom et al. identifies 20 actions that increase carbon storage and/or mitigate emissions, including
          reforestation, trees in cropland, and fire management.
        </p>
        <p>
          Most NCS actions{' '}
          <q>
            also offer water filtration, flood buffering, soil health, biodiversity habitat, and enhanced climate
            resilience
          </q>
          .
        </p>
        <p>
          Natural Climate Solutions tend not to receive the headlines. Tree planting is an exception. Many countries
          have promised to plant trees, and large scale projects in Ethiopia, Pakistan, India, China and elsewhere have
          taken place.
        </p>
        <p>
          There are several high profile global campaigns including{' '}
          <Links.EL link={{ source: 'https://www.1t.org/' }}>1 trillion trees</Links.EL> backed by the World Economic
          Forum, and <Links.EL link={{ source: 'https://trilliontrees.org/home' }}>Trillion Trees</Links.EL>.
        </p>
        <p>
          These projects are framed in such a way as to attract public attention by describing problems and solutions in
          terms of something familiar.
        </p>
        <p>But are trees a good unit of measurement?</p>
        <p>
          Scientists generally talk about forests rather than trees, and measure them in hectares. It is when bringing
          their findings to public attention that they switch to talking about trees. Campaigners, politicians, and
          protesters similarly prefer trees over hectares.
        </p>
        <h3>What is a tree?</h3>
        <p>
          There is no formal definition. Trees are not part of a taxonomic group but a loose collection of families and
        ...
        <p>
          The{' '}
          <Links.EL link={{ source: 'https://ourworldindata.org/grapher/number-of-trees' }}>
            distribution of trees
          </Links.EL>{' '}
          varies. Russia has a high number of trees whereas North Africa, the Middle East and Europe have relatively
          few.
        </p>
        ...
        <p>
          ...
          <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Tree_height_measurement' }}>
            measure a tree's height
          </Links.EL>
          , and a number of smartphone apps.
        </p>
        <Accordion header="How to calculate the weight of a tree">
          <aside>
            ...
            <ul>
              ...
              <li>
                Diameter of the tree at 1.3 metres. (Diameter at Breast Height -{' '}
                <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Diameter_at_breast_height' }}>DBH</Links.EL>).
              </li>
              <li>Height of the stem or trunk in metres.</li>
            </ul>
            <div>
              Scientists in Edinburgh show how to use these values to{' '}
        ...
        <p>
          In a mature tree the bulk of its weight - 60+% - is in the trunk, 10% in the branches, and a few percent in
          the leaves. The weight of a tree's roots varies between 20% and 30% of the whole.
        </p>
        <p>
          These ratios make it possible to calculate the total weight of a living tree from one value, usually the
          weight of the trunk.
        </p>
        <p>
          The distribution of weight varies between species, and over time; younger trees usually have a greater
          proportion of leaf mass, and a relatively small trunk.
        </p>

        <p>
          The method used to find the weight of a tree can be extended to calculate the amount of carbon captured by a
          tree through photosynthesis and its equivalent value of carbon dioxide.{' '}
        </p>
        ...
        <Accordion header="Photosynthesis">
          <aside>
            ...
            <div>
              Photosynthesis is the process by which energy from the sun is used to convert carbon dioxide and water
              into sugars that are used to build organic matter in plants.
            </div>
            <p>
              6<Formula>CO2</Formula> + 6<Formula>H2O</Formula> + sunlight → <Formula>C6H12O6</Formula> + 6
              <Formula>O2</Formula>
            </p>
          </aside>
        </Accordion>
        ...
        <Accordion header="Wood density">
          <aside>
            <h4>Wood density</h4>
            <div>
              Wood density and wood{' '}
              <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Relative_density' }}>specific gravity</Links.EL>{' '}
        ...
        <blockquote cite="https://www.britannica.com/science/wood-plant-tissue/Hygroscopicity">
          The moisture content of the wood of living trees varies from about 30 to 300 percent depending on species,
          position of the wood in the tree, and season of the year.
        </blockquote>
        <cite>
          <Links.EL link={{ source: 'https://www.britannica.com/science/wood-plant-tissue/Hygroscopicity' }}>
            Hygroscopicity | Encyclopedia Britannica
          </Links.EL>{' '}
        </cite>
        <p>
          The{' '}
          <Links.EL link={{ source: 'https://www.wagnermeters.com/specific-gravity/s/' }}>
            wood density for <em>Acer pseudoplatanus</em>
          </Links.EL>{' '}
          - sycamore - with 12% moisture content is 0.57, close to 0.5 with no water.
        </p>
        <p>
          The{' '}
        ...
        <Accordion header="Carbon in a sycamore tree">
          <aside>
            <h4>
              Carbon & <Formula>CO2</Formula> in a 2 tonne sycamore tree
            </h4>
            <dl>
              <dt>
              ...
              <dd>2000 kg &#215; 0.5 = 1000 kg</dd>
              <dt>
                <strong>Weight of carbon</strong>
              </dt>
              <dd>1000 kg &#215; 47.5% = 475 kg</dd>
              <dt>
                <strong>
        ...
        <p>
          Although values for carbon emissions are sometimes given in tonnes of <em>carbon</em>, they are more often
          given in tonnes of carbon <em>dioxide</em>; if a given figure looks suspiciously low, check the units being
          used.
        </p>
        ...
        <Accordion header="Converting carbon to carbon dioxide">
          <aside>
            ...
            <dl>
              <dt>
                <strong>The atomic masses of carbon and oxygen</strong>
              </dt>
              <dd>Carbon 12 - Oxygen 16</dd>
              <dt>
                <strong>
                  The atomic mass of <Formula>CO2</Formula>
                </strong>
              </dt>
              <dd>(1&#215;12) + (2&#215;16) = 44</dd>
              <dt>
                <strong>
                  The ratio of <Formula>CO2</Formula> to C
                </strong>
              </dt>
              <dd>
        ...
        <p>
          The standard unit of measurement is the metric <em>tonne</em>. A US ton is slightly lighter, an imperial
          (British) ton slightly heavier. Some articles confuse or conflate these units.
        </p>
        ...
        <Accordion header="Trees to absorb all GHG emissions">
          <aside>
            ...
            <div>
              Natural sinks (oceans and land) take up{' '}
              <Links.EL link={{ source: 'https://www.globalcarbonproject.org/carbonbudget/20/highlights.htm' }}>
                {' '}
                ~50% of <Formula>CO2</Formula> emitted
              </Links.EL>
              .
            </div>
            <dl>
              ...
              <dd>50 Gt</dd>
              <dt>
                <strong>Total net emissions</strong>
              </dt>
              <dd>25 Gt</dd>
              <dt>
                <strong>Carbon stored per tree per year</strong>
              </dt>
              <dd>20 kg</dd>
              <dt>
                <strong>Number of trees required</strong>
              </dt>
              <dd>25 Gigatonnes &#247; .02 tonnes = 1.25 trillion trees</dd>
            </dl>
          </aside>
        </Accordion>
        <p>
          A rough estimate of the number of trees needed to compensate for all net greenhouse gas emissions is 1.25
          trillion.
        </p>
        <p>
          This estimate leaves out one critical dimension - the time it takes a tree to grow. Whether a tree reaches
          maturity in 10, 20 or even 30 years depends on its species and habitat.
        </p>
        <p>
          The estimate can be checked by working backwards from the amount of carbon dioxide that is currently absorbed
          by the world's forests.
        </p>
        <p>
          Forests absorb roughly{' '}
          <Links.EL link={{ source: 'https://www.nature.com/articles/s41558-020-00976-6' }}>
            7.6 billion tonnes of <Formula>CO2</Formula>
          </Links.EL>{' '}
          annually - just over 15% of total greenhouse gas emissions.
        </p>
        <p>If 3 trillion trees sequester 7.6 billion tonnes, 1 trillion trees sequester roughly 2.5 billion tonnes.</p>
        <p>
          That is just <em>one tenth</em> of annual <em>net</em> emissions. Which suggests trees absorb on average 2.5
          kg annually, not 25 kg.
        </p>
        <h4>Cumulative emissions absorbed by the end of the century</h4>
        <p>
          The projected cumulative value for sequestered carbon by the end of the century (almost 80 years) is 80 &#215;
          2.5 billion tonnes = 200 billion tonnes.
        </p>
        <p>
          Thomas Crowther claimed in September 2019 that the Earth could sustain an additional{' '}
          <Links.EL link={{ source: 'https://www.nature.com/articles/d41586-019-02846-4' }}>
            1.2 trillion trees
          </Links.EL>{' '}
          able to absorb 200 gigatonnes of carbon by the end of the century.
        </p>
        <p>
          These final figures tally - a gigatonne is the same as one billion tonnes - but the calculations are starting
          to feel a little too rough, conjectures rather than assertions.
        </p>
        <p>
          This vagueness is amplified by uncertainty as to the data - the{' '}
          <Links.EL link={{ source: 'https://science.sciencemag.org/content/365/6448/76' }}>research</Links.EL> on which
          Crowther based his conclusion has been the subject of healthy scientific debate. The paper from Bastin et al.
          has been criticised by{' '}
          <Links.EL link={{ source: 'https://science.sciencemag.org/content/366/6463/eaaz0388' }}>
            Lewis et al.
          </Links.EL>
          ,{' '}
          <Links.EL
          ...
          To which the authors have{' '}
          <Links.EL link={{ source: 'https://science.sciencemag.org/content/366/6463/eaay8108' }}>responded</Links.EL>.
        </p>
        <p>
          This debate between scientists is illustrative; there is consensus on climate change, but the data in many
          areas are wanting or at best informed guesses.
        </p>
        <p>
          The Grantham Institute's estimate of carbon sequestration is more sober -{' '}
          <Links.EL
            link={{
              source:
                'https://spiral.imperial.ac.uk:8443/bitstream/10044/1/80271/6/What%20role%20can%20forests%20play%20in%20tackling%20climate%20change.pdf',
          ...
          by the time newly planted forests reach maturity.
        </p>
        ...
        <p>
          One of the first activities to offer the option to offset emissions was flying. Many offset schemes now focus
          on a wide variety of projects designed to reduce carbon emissions but planting trees is still a popular
          metric.
        </p>
        <Accordion header="Tree carbon sequestration per person">
          <aside>
            ...
            <p>
              Total emissions for all greenhouse gases is around{' '}
              <Links.EL link={{ source: 'https://ourworldindata.org/greenhouse-gas-emissions' }}>
                50 billion tonnes of <Formula>CO2</Formula>e
              </Links.EL>{' '}
              every year. Given a population of 8 billion, that equates to 6.25 tonnes per person per year.
            </p>
            <dl>
              <dt>
                <strong>Annual carbon sequestration per tree</strong>
              </dt>
              <dd>20 kg</dd>
              <dt>
                <strong>Average per capita emissions</strong>
              </dt>
              <dd>
                6.5 tonnes <Formula>CO2</Formula>e
              </dd>
              <dt>
                <strong>Trees per person</strong>
              </dt>
        ...
        <p>
          325 mature trees would be needed for each person in order to absorb the net carbon dioxide added to the
          atmosphere.
        </p>
        ...
        <h3>Forests</h3>
        <p>
          Trees are a popular but vague measure for calculating potential carbon sequestration. Their rate of absorbing
          carbon dioxide varies considerably according to species and habitat. Individual lifespan and survival rates
          are unpredictable.
        </p>
        <p>
          Although trees are used as proxies for forests they represent a small fraction of the total biomass found
          there, and are only one of many sources and sinks of carbon.
        </p>
        <p>
        ...
        <p>
          ...
          atmosphere, and absorbed 16 billion tonnes. Their data combined ground measurements with satellite
          observations.
        </p>
        <p>
        ...
        <blockquote cite="https://e360.yale.edu/features/will-climate-change-upend-projections-of-future-forest-growth">
          ...
          forest growth, warming soils seem to emit substantially more CO2 than previously believed, and climate-driven
          scourges threaten to kill trees faster than they can grow, turning forests globally into sources, not sinks,
          of carbon.
        </blockquote>
        ...
        <h4>Albedo effect</h4>
        <p>
          The albedo effect is an unintended consequence of planting trees that grow slowly because of short growing
          seasons on land that previously radiated sunlight from snow, ice or less dark soils and vegetation.
        </p>
        ...
        <h3>Conclusion</h3>
        <p>
          In the decade since 2010 net loss in forests globally was 4.7 million hectares per year. Much of that loss was
          in old forests, especially in the tropics. Newly planted trees are not a like for like replacement.
        </p>
        <p>
          Forests sequester 15% of excess carbon dioxide from the atmosphere. Protected and extended they could
          sequester emissions that are not easily prevented.
        </p>
        <p>
          Deforestation rates fall as countries become wealthier. At a certain point forest area begins to increase, as
          has occurred in Europe and the US. If richer countries stop contributing to deforestation in poorer countries,
          and actively support local people to maintain forests, global deforestation can be halted.
        </p>
        <p>
          Forests have been cleared for timber and especially to make way for crops. 37% of land is occupied by forests.
          50% by agriculture. We have become, however, more efficient in our use of land.
        </p>
        <blockquote cite="https://ourworldindata.org/deforestation">
          Since 1961, the amount of land we use for agriculture increased by only 7%. Meanwhile, the global population
          increased by 147% – from 3.1 to 7.6 billion. This means that agricultural land per person more than halved,
          from 1.45 to 0.63 hectares.
        </blockquote>
        <cite>
          <Links.EL link={{ source: 'https://ourworldindata.org/deforestation' }}>
            Deforestation and Forest Loss | Our World in Data
          </Links.EL>{' '}
        </cite>
        <p>
          Many solutions will be required to curb and offset our carbon dioxide emissions. Maintaining and restoring the
          world's existing forests preserves natural sinks upon which we are heavily dependent for reducing carbon
          dioxide in the atmosphere. They also provide a range of additional services far beyond one dimensional
          technological fixes. Tropical forests alone{' '}
          <Links.EL link={{ source: 'https://www.pnas.org/content/114/23/5775' }}>
            support two thirds of species
          </Links.EL>{' '}
          on less than 10% of the Earth's land surface.
        </p>
        <p>
          Technology is being used to map and record natural resources including forests. A record of what exists and
          the ability to monitor the effects of climate change and land use change is key for assessing the value of the
          natural world, and preserving it.
        </p>
        <p>
          There are good reasons to plant trees where there were none - afforestation - when doing so is not at the
          expense of healthy ecosystems, and for planting native trees, or allowing natural rewilding, where they have
          been lost - reforestation. In addition to planting trees, existing forests must be left intact.
        </p>
        <p>
          The ecosystems which trees foster are critical for life, and together with other natural climate solutions
          such as peatland and the three main marine ecosystems - seagrass, mangroves and salt marshes - they are
          integral to conserving biodiversity, human health and mitigating negative aspects of climate change.
        </p>
        <Top></Top>
      </section>
      <section>
