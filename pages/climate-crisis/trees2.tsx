...
const Trees2 = () => {
    ...
    const references = [
        ...
        },
        {
            ...
            source: "https://science.sciencemag.org/content/366/6463/eaay8060?ijkey=4941132eebc36136e6c4b1ccea847d2fdddb01ad&keytype2=tf_ipsecsha"
        },
        {
            name: "Comment on “The global tree restoration potential” | Veldman et al.",
            source: "https://science.sciencemag.org/content/366/6463/eaay7976?ijkey=866eac34ce3783e0f1f6d537b68f296534f4faf3&keytype2=tf_ipsecsha"
        },
        {
        ...
        },
        {
            ...
            source: "https://ec.europa.eu/info/publications/eu-communication-2019-stepping-eu-action-protect-and-restore-worlds-forests_en"
        },
    ];
    ...
    return (
        ...
        <section>
            ...
            <p>We're going to pick up where we left off in the previous article, by looking at more detail on the article from the Crowther Lab, <Links.EL link={{source:'https://science.sciencemag.org/content/365/6448/76'}}>The global tree restoration potential</Links.EL>.</p>
            ...
            <blockquote cite='https://www.nature.com/articles/ncomms13428'>
                <div>We report a recent pause in the growth rate of atmospheric CO2, and a decline in the fraction of anthropogenic emissions that remain in the atmosphere, despite increasing anthropogenic emissions.</div>
                <div>The pause in the atmospheric CO2 growth rate provides further evidence of the roles of CO2 fertilization and warming-induced respiration, and highlights the need to protect both existing carbon stocks and regions, where the sink is growing rapidly.</div>                
            </blockquote>
            <cite><Links.EL link={{source:'https://www.nature.com/articles/ncomms13428'}}>Recent pause in the growth rate of atmospheric <Formula>CO2</Formula></Links.EL></cite>
