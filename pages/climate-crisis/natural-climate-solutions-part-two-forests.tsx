    ...
    return (
        <Layout header="Natural climate solutions - Forests" rt="9 to 10" title="natural-climate-solutions-part-one-forests" description={'Forests'}>
            ...
            <h3>Land use</h3>
                ...
                <p>Gabriel Popkin presents a review of the current thinking in his article at Yale Environment, <Links.EL link={{source:'https://e360.yale.edu/features/will-climate-change-upend-projections-of-future-forest-growth'}}>Will Climate Change Upend Projections of Future Forest Growth?</Links.EL> He concludes:</p>
                ...
                <p>BECSS is…</p>
                <p>In theory…</p>
                <p>There are at least <Links.EL link={{source:'https://www.carbonbrief.org/explainer-10-ways-negative-emissions-could-slow-climate-change'}}>ten negative emissions technologies</Links.EL>. Of these BECCS and DAC have the loudest advocates but they are unproven. Though these technologies are undoubtedly interesting, and in some cases ingenious, it is naive to assume either their efficacy or practicality. Previous transitions and revolutions in energy, agriculture and construction have taken a long time, despite clear benefits and, in time, financial reward.</p>
                <h3>Conclusion</h3>
                ...
                <p>The multiple chemical and biological processes that combine in photosynthesis and respiration enable plants to convert carbon dioxide, water and energy from the sun into sugars from which plants assemble their own forms, and by extension provide the food and materials to sustain all other life on the planet.</p>
