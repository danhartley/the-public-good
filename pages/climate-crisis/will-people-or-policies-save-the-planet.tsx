...
const CarbonFootprint = () => {
  return (
    <Layout
      header="Will people or policies save the planet?"
      rt="8 to 9"
      title="Climate crisis | Will people or policies save the planet?"
      description={
        'An introduction to greenhouse gas emissions, carbon budgets, and personal carbon footprint calculators with comparison of 5 calculators.'
      }
    >
      <section>
        <h2 id="intro">
        ...
        <p>
          ...
          <ul class={styles.dashedItemsList}>
            ...
            <li>
              Total CO2:{' '}
              <Links.EL link={{ source: 'https://ourworldindata.org/co2-emissions' }}>
                36.44 billion tonnes of CO2
              </Links.EL>
              .
            </li>
            <li>
              ...
              <Links.EL link={{ source: 'https://ourworldindata.org/greenhouse-gas-emissions' }}>
                49.36 billion tonnes of CO2e
              </Links.EL>{' '}
              (2016).
            </li>
            <li>
              World population:{' '}
              <Links.EL link={{ source: 'https://ourworldindata.org/world-population-growth' }}>7.55 billion</Links.EL>{' '}
              <a id="data" href="#discrepancy">
                *
              </a>
              .
            </li>
          ...
          <div class={styles.inset}>
            <div>
              ...
              <Links.EL link={{ source: 'https://www.nature.com/articles/d41586-021-00090-3' }}>
                Nature, 6.4% (2.3 billion tonnes)
              </Links.EL>
              ,{' '}
              <Links.EL link={{ source: 'https://www.iea.org/articles/global-energy-review-co2-emissions-in-2020' }}>
                IEA 5.8%
              </Links.EL>
              , <Links.EL link={{ source: 'https://carbonmonitor.org/' }}>Carbon Monitor 4%</Links.EL>.
            </div>
            <span>
              <Links.EL link={{ source: 'https://carbonmonitor.org/' }}>Daily estimates</Links.EL> are also available
              from Carbon Monitor.
            </span>
          </div>
        </p>
        ...
        <p>
          Unfortunately CO2 is not the only greenhouse gas; emissions from methane, nitrous oxide, and{' '}
          <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Fluorinated_gases' }}>Fluorinated gases</Links.EL>{' '}
          (F-gases) must also be taken into account. Total emissions are measured using{' '}
          <Links.EL
            link={{
              label: 'Our World in Data, How do we quantify greenhouse gas emissions?',
              source: 'https://ourworldindata.org/greenhouse-gas-emissions#how-are-greenhouse-gases-measured',
            }}
          >
        ...
        <p>
          ...
          <div>
            If we extend this finding to all rich countries, it would be impossible for even the most diligent
            individual to live sustainably; before they had eaten one mouthful of food or taken one hot shower, they
            would be living beyond the capacity of the planet to support them.
          </div>
          <div>
            <p>
              <div>
        ...
        <ul class={styles.dashedItemsList}>
          <li>
            <span>
              ...
              and Mathis Wackernagel use the term{' '}
              <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Ecological_footprint' }}>
                ecological footprint
              </Links.EL>{' '}
              for the first time in an academic publication.
            </span>
          </li>
          <li>
            <span>
              BP launches the first{' '}
              <Links.EL
                link={{ source: 'https://mashable.com/feature/carbon-footprint-pr-campaign-sham/?europe=true' }}
              >
                carbon footprint calculator
              </Links.EL>{' '}
              and spends millions promoting the concept.
            </span>
          </li>
          <li>
            <span>
              BP launches a{' '}
              <Links.EL link={{ source: 'https://www.knowyourcarbonfootprint.com/' }}>
                second carbon calculator
              </Links.EL>
              . It does not receive a favourable{' '}
        ...
        <p>
          There are numerous carbon footprint calculators. I have listed a few that seem more or less accurate but I
          would recommend using three or four to obtain an average. Any value should be treated as a rough
          approximation. As emissions are tied to particular goods and services, we can expect greater accuracy and
          specificity.
        </p>
        ...
        <p>
          <strong>Why are there such large discrepancies between footprints?</strong>
        </p>

        <p>
          Calculators accept a variety of information, and differ as to external baseline data and assumptions; this
          does not necessarily make one better than another; all of these calculators are well researched, and
          independently valuable, but direct comparison between them is not possible. Discrepancies are a cautionary
          reminder that, when dealing with climate change figures, it is more constructive to think in terms of ranges
          than specific figures, and that the ranges themselves fluctuate. The value of our footprint is seductive, an
          effective means of engagement; how the number was derived{' '}
          <Links.EL link={{ source: 'https://mossy.earth/methodologies/carbon-footprint-calculator' }}>
            is more valuable
          </Links.EL>
          .
        </p>
        ...
        <p>
          Calculators are necessarily constrained by the information we provide, but whilst certain inferences can be
          made from the data we do provide, they are agnostic as to some important factors that affect our behaviour and
          options; wealthier people have more choice as to where they live, and how they live. Nor do these calculators
          take into account our work which may have a footprint at odds with our private one. The reason for this is to
          avoid double counting emissions - if you make cars, the car owners are responsible for those emissions, not
          the manufacturer; but since these are personal emissions calculators, this limits their value.
        </p>

        <p>
          And finally, they are snapshots, which don't take into account our history, or future plans. If we assume that
          carbon emissions must peak, and decline, in order to meet the goals set in Paris in 2015, the effect on
          individual{' '}
          <Links.EL
            link={{
              source:
        ...
        <p>
          Carbon footprints are sometimes used as a proxy for individual acts, which are then placed in opposition to
          political or social acts, limiting choice to one or the other, either/or.
        </p>

        <p>
          One reason for this polarity is that fossil fuel companies have promoted the idea that emissions reduction is
          the responsibility of individuals, and one of the tools they have used is the carbon footprint; not only was
          BP the first to popularise the concept, they have released carbon footprint calculators twice, in 2006 and
          2020, to coincide with campaigns defending or stating their green credentials.
        </p>
        ...
        <p>
          ...
          think we can combine personal and political action, then we should, and trust others to do the same.
        </p>

        <p>
          <span>
            What of the actions themselves, do they have{' '}
            <Links.EL link={{ source: 'https://en.wikipedia.org/wiki/Intrinsic_value_(ethics)' }}>
              intrinsic value
            </Links.EL>
            ? Does knowing the average emission of a transatlantic flight, or the carbon dioxide-equivalent per kilo of
            beef mean anything?
          </span>
        </p>

        <p>
          A decision which may involve inconvenience, loss of income, or the forfeit of a pleasure, is sustained more
          readily when it has solid foundations, for then the reason behind, and the need for, the change, is clear,
          even if any ultimate benefit that accrues is indiscernible.
        </p>

        <p>
          It is against the grain for most to forego gratification or gain, but it is hard to ignore that which is right
          to do, when that right has been established and understood. We may call this conscience, sense of duty, or
          moral imperative; and we may discover that acting in accordance with our beliefs and our understanding, is
        ...
        <p>
          Carbon footprint calculators have value as an introduction to the consequences of our choices, and as a
          starting point for examining our interdependency, lack of autonomy, and the limits pertaining to personal
          action.
        </p>

        <p>
          Footprints would be improved by making the implicit cost of services explicit. This intrinsic, background
          value for a society is the floor below which individual action cannot take us, and which can only be breached
          by direct, participatory action that brings about policy change.
        </p>
      ...
      <section id="discrepancy">
        <p>
          * There is a discrepancy hidden in these figures:
          ...
          taken credit.
          <div>
            <Links.IL link={{ source: 'climate-crisis/will-people-or-policies-save-the-planet/#data' }}>
      ...
      <section id="profile">
        <p>
          ...
          <div>
            <Links.IL link={{ source: 'climate-crisis/will-people-or-policies-save-the-planet/#table' }}>
      ...
      <Published
        strDate="Sat 27 March 2021"
        edited={[
          { strDate: 'Mon 29 March 2021' },
          { strDate: 'Fri 2 April 2021', text: 'Use IPCC values for natural carbon sinks' },
          { strDate: 'Tues 6 April 2021', text: 'Added David MacKay quote' },
          { strDate: 'Thu 13 May 2021', text: 'Rewrite' },
        ]}
      ></Published>
