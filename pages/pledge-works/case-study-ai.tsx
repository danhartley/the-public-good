    ...
    return (
        <>
            <Layout header="Ethics at work"  rt="3" title="Ethics at work" description={'It is impossible to defend ethical behaviour on economic grounds; nor is it necessary.'} discussions='/categories/pledge-works'> {/* image? */}
                <section>
                    <h2>Considering the consequence of our actions and changing our behaviour accordingly does not require a company code of ethics. </h2>
                    <p>The workplace is a fit environment for applied ethics. We frequently consider risk, undesirable consequences, and competing outcomes. Processes exist to measure progress, share information and save time.</p>
                    <p>Pledge Works is an adaptation that requires minimal effort in return for outcomes that improve upon business as usual defaults.</p>
                    <p>It is a deliberately simple approach; write pledges that frame or guide the next product or product feature you are planning. Pledges are specific to the team or individual and the context. They contain just enough character to be meaningful without being dogmatic.</p>
                    {/* <p>A lot of work time is spent getting, or trying to get, things done. It is tempting to think less and do more.</p> */}
                    ...
                    <p>We move from one ethical position to the next, at each stage providing more detail in a cascade of inherited statements.</p>
