    ...
    return (
        <Layout header="Projects" title="Web Projects" description={'Web Projects'}>
            <section>
                ...
                <p>                             
                    <p><h2><Links.EL link={{source:'https://www.learn-the-planet.com/'}}> Learn the Planet</Links.EL></h2>                                   
                        ...
                        <ul class={styles.dashedItemsList}>                            
                                <li>The switch to <Links.EL link={{source:'https://webpack.js.org'}}>webpack</Links.EL> from <Links.EL link={{source:'https://gruntjs.com/'}}>Grunt</Links.EL> for bundling and optimising files.</li>
                                <li>A shift from building <Links.EL link={{source:'https://developer.mozilla.org/en-US/docs/Glossary/SPA'}}>Single Page Apps</Links.EL> to <Links.EL link={{source:'web.dev/progressive-web-apps/'}}>Progressive Web Apps</Links.EL>.</li>
                                <li>Hosting the site on <Links.EL link={{source:'https://cloud.google.com'}}>Google's Cloud Platform</Links.EL> and adding <Links.EL link={{source:'https://firebase.google.com/docs/functions'}}>serverless functions</Links.EL>.</li>
                                <li>Increased testing, using <Links.EL link={{source:'https://jestjs.io/'}}>Jest</Links.EL>, and, at times, <Links.EL link={{source:'https://www.freecodecamp.org/news/test-driven-development-what-it-is-and-what-it-is-not-41fa6bca02a2/'}}>Test Driven Development</Links.EL>.</li>                            
                        </ul>
                    ...
                    <p>
                        ...
                        <ul class={styles.dashedItemsList}>
                            <li><Links.EL link={{source:'https://nextjs.org/'}}>Next.js</Links.EL> for Static Site Generation.</li>
                            <li><Links.EL link={{source:'https://www.netlify.com/'}}>netlify</Links.EL> to serve pages.</li>
                            <li>Netlify's <Links.EL link={{source:'https://www.netlifycms.org/'}}>headless CMS</Links.EL>.</li>
                        </ul>
                    </p>
                </p>
            </section>
