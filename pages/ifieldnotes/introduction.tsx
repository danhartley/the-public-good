...
const Introduction = () => {
  return (
    <Layout
      header="Introduction 2024 iFieldnotes.org"
      title="Introduction 2024 iFieldnotes.org"
      description={'Introduction 2024 iFieldnotes.org'}
    ...
    >
      <section>
        <div class={styles.day}>
          <span class={styles.date}>Friday 09 2024</span>
