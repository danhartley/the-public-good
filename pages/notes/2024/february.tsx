    ...
    >
      <section>
        <div className={styles.day}>
          <span className={styles.date}>Sunday 18 February 2024</span>
        ...
        <div className={styles.day}>
          <span className={styles.date}>Tuesday 27 February 2024</span>

          <h2>Farming & Biodiversity</h2>

          <Links.EL link={{ source: 'https://www.nature.com/articles/s44185-023-00034-2' }}>
            Farming practices to enhance biodiversity across biomes: a systematic review
          </Links.EL>

          <ul>
            <li>
              Biodiversity is declining at an unprecedented pace around the world, with current estimates that around 5%
              of all species will be lost every ten years.
            </li>
            <li>
              The main driver of biodiversity loss is agriculture, both through intensification of existing agricultural
              land and expansion of agriculture into pristine ecosystems.
            </li>
            <li>
              Intensification of agricultural practices in recent decades (…leads) to increase yields to the detriment
              of other key ecosystem services, such as pollination, nitrogen cycling, carbon storage or resistance to
              drought.
            </li>
          ...
          <ul>
            <li>
              Our findings show that no single practice enhances all taxonomic groups, but that alternative, less
              intensive agricultural practices are often beneficial to global biodiversity when compared to intensive
              conventional practices.
            </li>
            <li>
              We identified 35 alternative agricultural practices for which responses of seven studied taxa (arthropods,
              birds, mammals, earthworms, nematodes, bacteria and fungi) have been reported. We categorized these
              practices into ‘Groups of practices’ with a similar function (e.g., minimum tillage and conservation
              tillage).
            </li>
            <li>
            ...
            <li>
              We identified four practices that benefitted multiple taxonomic groups, henceforth referred to as “no
              regret” practices, that enhance combined biodiversity without adversely affecting any specific taxonomic
              group.
            </li>
            <li>
              Practices in the group of planned biodiversity interferences and no pesticide use were clearly positive in
              a vast majority of cases, with almost no negative incidence across taxonomic groups.
            </li>
            <li>We also found five individual practices that enhanced specific taxa.</li>
            <li>
              Biodiversity-friendly practices alone will not suffice and should be coupled with a concomitant strategy
              to prevent further expansion of agricultural lands and restore and preserve existing natural areas.
            </li>
            <li>
              Biodiversity conservation is a systemic issue and our results clearly stress the importance of
              simultaneously addressing multiple aspects of biodiversity (e.g., soil organisms, arthropods, birds) for
          ...
          <Links.EL link={{ source: 'https://www.youtube.com/watch?v=5QOTBreQaIk' }}>
            The harsh reality of ultra processed food | Royal Society | Chris Van Tulleken
          </Links.EL>
          <p>
            The industrialisation and commercialisation of food have transformed our diets, whereby most of our calories
            now come from an entirely novel set of substances. Ultra Processed Food (UPF) now makes up 60% of the
            average diet in the UK and USA. It is highly processed, highly addictive, and largely unhealthy.
          </p>

          <Links.EL link={{ source: 'https://www.youtube.com/watch?v=4S9sDyooxf4' }}>
            Climate sensitivity | Sabine Hossenfelder
          </Links.EL>
          <Links.EL link={{ source: 'https://www.youtube.com/watch?v=q4EuvpDzlUY' }}>
            Climate sensitivity reposte | Climate Adam
          </Links.EL>
        </div>
      </section>
