  ...
  return (
    ...
    >
      <section>
        ...
        Topics covered
        <ul>
          <li>Boolean logic (AND, OR, NOT and XOR) and gates - used in the creation of circuits to determine input and output</li>
          ...
          <li>Long term memory enabled by creating configurations of inputs and gates that always yield the same result (0 or 1)</li>
          ...
          <li>Arithmetic Logic Unit (ALU) is a combinational digital circuit that performs arithmetic and bitwise operations on integer binary numbers</li>
        </ul>
        ...
        State
          <ul>
            ...
            <li>State can be changed (from read only to writable) by changing the state of a latch which then allows gates to reopen (or close)</li>
            <li>The brain is also a (relatively) fixed structure. A memory is similar to repeating a question to an LLM</li>
            <li>The response may be more or less fixed (low temperature comparable to a calculator summing 2 and 2) depending on complexity, frequency, etc.</li>
            <li>Brain physical and subject to change: deterioration (age or illness), damage, use (repeated recall, common tasks like simple maths, everyday language)</li>
          </ul>    

        <div>
          <Links.EL link={{ source: 'https://www.youtube.com/watch?v=tpIctyqH29Q&list=PL8dPuuaLjXtNlUrzyH5r6jN9ulIgZBpdo&index=1' }}>
